...
class intrusive_list_test : public testing::Test {
 protected:
  ...
  fpl::intrusive_list<IntegerListNode, &IntegerListNode::node> list_;
...
TEST_F(intrusive_list_test, insert_before) {
  ...
  ++iter;
  ++iter;
  fpl::intrusive_list<IntegerListNode, &IntegerListNode::node>::insert_before(
      *iter, ten_);
...
TEST_F(intrusive_list_test, insert_after) {
  ...
  auto iter = list_.begin();
  ++iter;
  fpl::intrusive_list<IntegerListNode, &IntegerListNode::node>::insert_after(
      *iter, ten_);
...
TEST_F(intrusive_list_test, splice_empty) {
  ...
  fpl::intrusive_list<IntegerListNode, &IntegerListNode::node> other_list;
...
TEST_F(intrusive_list_test, move_constructor) {
  ...
  fpl::intrusive_list<IntegerListNode, &IntegerListNode::node> other(
      std::move(list_));
